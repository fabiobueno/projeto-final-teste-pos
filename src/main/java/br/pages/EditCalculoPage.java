...
public class EditCalculoPage {
    private WebDriver driver;

    public EditCalculoPage(WebDriver driver) {
        this.driver = driver;
    }

    public void editaRegistro(String nome, String dependentes, String timeToWork, String salaryHour) {
